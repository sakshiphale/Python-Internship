...
sakshi.geometry("750x450")


sakshi.title("Rock Paper Scissors...")
...
def reset():
   ...
   l1.config(text = "Sakshi")
   l3.config(text = "Computer")
   label.config(text = "")



labelframe= LabelFrame(sakshi, text= "Rock Paper Scissor", font= ('Arial 20 bold'),labelanchor= "n",bd=5,bg= "Cyan2" ,width= 600, height= 450, cursor= "target")
labelframe.pack(expand= True, fill= BOTH)


l1= Label(labelframe, text="sakshi", font= ('Helvetica 18 bold'),bg="OrangeRed3",fg="white")
